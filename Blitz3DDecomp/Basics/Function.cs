...
sealed class Function
{
    ...
    public static readonly List<Function> AllFunctions = new Function[]
    {
        ...
        new Function("_builtIn__bbAbs", DeclType.Int) { ReturnType = DeclType.Int },
        new Function("_builtIn__bbFAbs", DeclType.Float) { ReturnType = DeclType.Float },
        new Function("_builtIn__bbFPow", DeclType.Float, DeclType.Float) { ReturnType = DeclType.Float },
        new Function("_builtIn__bbMod", DeclType.Int, DeclType.Int) { ReturnType = DeclType.Int },
        new Function("_builtIn__bbFMod", DeclType.Float, DeclType.Float) { ReturnType = DeclType.Float },
        ...
        new Function("_builtIn_ferrorlog", 0) { ReturnType = DeclType.String },
        ...
        new Function("_builtIn__bbObjCompare", 2),
        new Function("_builtIn__bbObjRelease", 1),
        new Function("_builtIn__bbObjStore", 2),
