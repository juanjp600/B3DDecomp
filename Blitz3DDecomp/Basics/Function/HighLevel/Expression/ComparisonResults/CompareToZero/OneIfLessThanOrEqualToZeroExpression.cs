...
sealed record OneIfLessThanOrEqualToZeroExpression(Expression OriginalExpression) : BooleanExpression
{
    ...
    public override BooleanExpression Negated
        => new OneIfGreaterThanZeroExpression(OriginalExpression);
}